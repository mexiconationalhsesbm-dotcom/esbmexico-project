...
export default function ConfirmDeleteTask({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-[480px] text-center z-99999999 p-8 bg-white dark:bg-gray-700">
        ...
        <DialogHeader className="flex items-center">
          ...
          <DialogDescription className="text-sm text-center text-gray-500 dark:text-gray-400 mt-2">
