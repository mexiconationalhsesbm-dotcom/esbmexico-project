...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ type = "text", className = "", success = false, error = false, hint, ...rest }, ref) => {
    // Base styles
    ...
    if (rest.disabled) {
      ...
      inputClasses += ` bg-transparent text-gray-800 border-gray-300 focus:border-brand-300 focus:ring-3 
