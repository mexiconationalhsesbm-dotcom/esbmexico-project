...
import { SharedFolderGrid } from "./shared-folder-grid"
...
export function ContentExplorerShared({ folders, files, dimensionId, currentUserId, dimensionSlug, currentFolderId, isSharedView = false, sharedFromDimensionId, accessLevel = "view", }: ContentExplorerProps) {
        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-medium">Folders</h2>
              ...
              <CreateFolderButton dimensionId={sharedFromDimensionId} parentFolderId={currentFolderId} createdBy={currentUserId}/>
              )}
              </div>
          </div>
        </div>
        <SharedFolderGrid folders={sortedFolders} dimensionSlug={dimensionSlug} dimensionId={sharedFromDimensionId} isSharedView={isSharedView} accessLevel = {accessLevel} />
      </div>
      <SortPanel
